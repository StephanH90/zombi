...
config :zombi, ZombiWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: ZombiWeb.ErrorHTML, json: ZombiWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Zombi.PubSub,
  live_view: [signing_salt: "HajZsRdM"]
...
config :zombi, Zombi.Mailer, adapter: Swoosh.Adapters.Local
...
# Time zone database, so DateTime.shift_zone/2 can convert UTC timestamps to the
# viewer's local zone (see ZombiWeb.Format).
