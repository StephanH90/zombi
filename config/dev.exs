...
config :zombi, ZombiWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "DRFoyuXrmKkc+hn99JLkk6KcLVzKFElTG4cK37GocgRIBu+ixzFSCBS2oI/kJOrJ",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:zombi, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:zombi, ~w(--watch)]}
  ]
...
config :zombi, ZombiWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/zombi_web/router\.ex$"E,
      ~r"lib/zombi_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :zombi, dev_routes: true
